...
#   Метод приема данных времени
    def time_put(self,year,month,day,hour,minute):
        ...
        self.times.append(str(year)+"-"+str(month)+"-"+str(day)+" "+str(hour)+":"+str(minute))
        return
...
#========================================
#a = plot()
#a.time_put(2021,4,1,0,0)
#a.time_put(2021,4,2,0,0)
#a.time_put(2021,4,3,0,0)
#a.time_put(2021,4,4,0,0)
